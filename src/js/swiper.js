...
$add.SliderObj = function(settings){
  ...
  this.renderer = function(){
    ...
    var $wrapper = $("<div class='addui-slider-wrapper'> </div>").appendTo($slider);
    var $track = $("<div class='addui-slider-track'></div>").appendTo($wrapper);
    var $range = $("<div class='addui-slider-range'></div>").appendTo($track);
    
    if(!this._settings.range){
      var $handle = $("<div class='addui-slider-handle'></div>").appendTo($slider);
